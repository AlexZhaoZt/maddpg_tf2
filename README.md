**This is a Tensorflow 2.0 implementation of the MADDPG algorithm. The code is largely based on the [original MADDPG implementation](https://github.com/openai/maddpg).** 
